...
module RallyUtils
  TOGGLES = ['ENABLE_BULK_EDIT_OF_ALL_FIELDS', 'PROVISION_TRIAL_AND_COMMUNITY_IN_PROD','IMPORT_TASKS','IMPORT_TEST_CASES_WITH_RELATIONSHIPS', 'NEW_FEEDBACK_STYLING', 'HARMONIZE_ALM_UI', 'CRAZYTRAIN_F4089_EDP_BETA', 'EDP_TASK_BETA', 'EDP_DEFECT_BETA', 'EDP_PORTFOLIO_ITEM_BETA', 'EDP_BETA_SET_PREFERENCE_ON_BY_DEFAULT', 'S63103_ENABLE_NEDP', 'VIEWPORT_IN_REACT']
  SUBSCRIPTIONS = {}
